...
const ONTFORM17A = ({ targetRef, matterId, onFormDataSave, savedData, setCourtNumber }) => {
  ...
  const handleInputChange = (path, value) => {
    ...
    console.log("🚀 ~ handleInputChange ~ pathArray:", pathArray)
        ...
        <div className='pdf-form pdf-form-8A mt-20px px-3' ref={targetRef}>
          ...
          <Row className='pb-3'>
            ...
            <Col xs={3}>
              ...
              <FormInfo
                number="17A"
                format={"Case Conference Brief – General"}
              />
            </Col>
          </Row>
          ...
          <div>
            ...
            {/* family Facts */}
            <div>
              <Subheading heading={'PART1: FAMILY FACTS'} />
              <ol>
                <li className='my-2'>
                ...
                <li className={"my-2"}>
                  <BasicChildren formData={formData} fillFormData={handleIndexChange} />
                </li>
                ...
                <li className={"my-2"}>
                  <Row>
                    <BoldandThinText thin={"Have any of the issues that have been settled been turned into a court order or a written agreement?"} />
                ...
                <li className={"my-2"}>
                  <Row>
                      ...
                      <div className='form-check'>
                        ...
                        <div className='data-input' style={{ justifyContent: "start" }}>
                          ...
                          <input
                            type='text'
                            className='custom-input-control'
                            value={formData?.item10?.no?.details}
                    ...
                    <Col xs={12}>
                      <textarea className='custom-input-control w-100'
                ...
                <div>
                  ...
                  <input
                      type='text'
                      style={{ border: "none", borderBottom: "1px dotted black ", boxShadow: "none", marginLeft: "10px" }}
                      onChange={fillFormData('part4.record')}
                      value={formData?.part4?.record}
                    />
...
Children’s Lawyer?`} />
                    ...
                    <Col xs={4}>
                      <CheckBox
                        ...
                        type='checkbox'
                        value={'no'}
                        labelinput={'item16.b.checked'}
                        fillFormData={fillFormData}
                        isBold={false}
                        checkbox={true}
                        checked={formData?.item16?.b.checked === 'no'}
                      />
                    </Col>
                    <Col xs={4}>
                      <CheckBox
                        ...
                        isBold={false}
                        checkbox={true}
                        checked={formData?.item16?.b.checked === 'yes'}
                      />
                    </Col>
                    <Col className='mt-2' xs={12}>
                      <textarea
