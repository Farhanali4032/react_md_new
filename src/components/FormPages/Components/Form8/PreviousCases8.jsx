...
function PreviousCasesOrAgreements8({ formData, fillFormData, changeFormCheck }) {
    ...
    return (
        <div className=''>
            ...
            <BoldandThinText centered bold={"PREVIOUS CASES OR AGREEMENTS"} />
            ...
            <div className='pt-5'>
                ...
                <BoldandThinText
                    thin={` Have the parties made a written agreement dealing with any matter involved in this case?`}
                />
                <div className='d-flex pb-10px'>
                    {radioInput(
            ...
            <div>
                ...
                <BoldandThinText
                    thin={` Has a Notice of Calculation and/or a Notice of Recalculation been issued by the online Child Support Service in this case?`}
                />
                <div className='d-flex pb-10px'>
                    {radioInput(
            ...
            <div>
                ...
                <BoldandThinText
                    thin={` If yes, are you asking the court to make an order for a child support that is different from the amount set out in the Notice?`}
                />
                <div className='d-flex pb-10px'>
                    {radioInput(
            ...
            <div>
                ...
                <BoldandThinText
                    thin={` Have the parties arbitrated or agreed to arbitrate any matter involved in this case?`}
                />
                <div className='d-flex pb-10px'>
                    {radioInput(
                        formData?.familyHistory?.prevCaseOrAgreements?.isAskingToMakeOrder?.checked,
                        'familyHistory.prevCaseOrAgreements.isAskingToMakeOrder.checked',
                        'No',
                        'isAskingToMakeOrder_no',
                        'isAskingToMakeOrder',
                        'no')}
                    {radioInput(
                        formData?.familyHistory?.prevCaseOrAgreements?.isAskingToMakeOrder?.checked,
                ...
                <div className='pb-3'>
                    <BorderLessInput
                        ...
                        fileno
                        onChange={fillFormData}
                        update={'familyHistory.prevCaseOrAgreements.isAskingToMakeOrder.details'}
                        value={formData?.familyHistory?.prevCaseOrAgreements?.isAskingToMakeOrder?.details}
                        style={{ padding: "6px 0", width: "100%" }}
...
export default PreviousCasesOrAgreements8;
