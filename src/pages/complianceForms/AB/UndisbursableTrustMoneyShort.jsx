...
import UndisbursableTrustMoneyShortPrint from "./print/UndisbursableTrustMoneyShortPrint";

const UndisbursableTrustMoneyShort = () => {
  ...
  return (
    <ComplianceFormLayout
      title="Undisbursable Trust Money - Short Form"
    ...
    >
      <div style={{ display: "none" }}>
        <UndisbursableTrustMoneyShortPrint
          taskData={taskState}
          ref={compliancePDF}
        />
      </div>
      <div>
        ...
        >
          ...
          >
            ...
            <div
              style={{ position: "absolute", left: "54.00px", top: "226.10px" }}
              className="cls_002"
            >
              <span className="cls_002">
            ...
            <div
              style={{ position: "absolute", left: "54.00px", top: "253.01px" }}
              className="cls_002"
            >
              <span className="cls_002">
                4. A member practising as a sole practitioner is a “Law Firm” as
                defined in the Rules.
              </span>
            </div>
            <div
              style={{ position: "absolute", left: "54.00px", top: "269.09px" }}
              className="cls_009"
            >
            ...
            <div
              style={{ position: "absolute", left: "54.00px", top: "296.09px" }}
              className="cls_002"
            >
              <span className="cls_002">
            ...
            <div
              style={{ position: "absolute", left: "54.00px", top: "339.65px" }}
              className="cls_012"
            >
              <span className="cls_012">SECTION A - LAW FIRM INFORMATION</span>
            </div>
            <div
              style={{ position: "absolute", left: "54.00px", top: "366.65px" }}
              className="cls_002"
            >
              <span className="cls_002">1.</span>
            </div>
            <div
              style={{ position: "absolute", left: "81.26px", top: "366.65px" }}
              className="cls_002"
            >
            ...
            <div
              style={{ position: "absolute", left: "54.00px", top: "384.41px" }}
              className="cls_002"
            >
              <span className="cls_002">2.</span>
            </div>
            <div
              style={{ position: "absolute", left: "81.26px", top: "384.41px" }}
              className="cls_002"
            >
            ...
            <div
              style={{ position: "absolute", left: "81.26px", top: "402.29px" }}
              className="cls_002"
            >
            ...
            <div
              style={{ position: "absolute", left: "54.00px", top: "420.17px" }}
              className="cls_002"
            >
              <span className="cls_002">3.</span>
            </div>
            <div
              style={{ position: "absolute", left: "81.26px", top: "420.17px" }}
              className="cls_002"
            >
            ...
            <div
              style={{ position: "absolute", left: "81.26px", top: "430.51px" }}
              className="cls_002"
            >
              <span className="cls_002">Number:</span>
            </div>
            <div
              style={{ position: "absolute", left: "54.00px", top: "446.83px" }}
              className="cls_002"
            >
              <span className="cls_002">4.</span>
            </div>
            <div
              style={{ position: "absolute", left: "81.26px", top: "446.83px" }}
              className="cls_002"
            >
            ...
            <div
              style={{ position: "absolute", left: "81.26px", top: "457.15px" }}
              className="cls_002"
            >
              <span className="cls_002">Lawyer:</span>
            </div>
            <div
              style={{ position: "absolute", left: "54.00px", top: "473.59px" }}
              className="cls_002"
            >
              <span className="cls_002">5.</span>
            </div>
            <div
              style={{ position: "absolute", left: "81.26px", top: "473.59px" }}
              className="cls_002"
            >
            ...
            <div
              style={{ position: "absolute", left: "54.00px", top: "515.35px" }}
              className="cls_012"
            >
            ...
            <div
              style={{ position: "absolute", left: "80.66px", top: "558.55px" }}
            ...
            >
              <span className="cls_016">
                ...
                additiona l information, or to obtain clarification on the
          ...
          >
            ...
            <div
              style={{ position: "absolute", left: "520.42px", top: "43.80px" }}
              className="cls_018"
            >
...
export default UndisbursableTrustMoneyShort;
