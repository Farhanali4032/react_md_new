...
import FinancialAuthFormPrint from "./print/FinancialAuthFormPrint";
...
const FinacInstAuthForm = () => {
  ...
  return (
    <ComplianceFormLayout
      title="Financial Institution Authorization Release"
    ...
    >
      <div style={{ display: "none" }}>
        <FinancialAuthFormPrint taskData={taskState} ref={compliancePDF} />
      </div>
      <div>
...
export default FinacInstAuthForm;
