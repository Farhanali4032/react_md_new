...
const RepresCapacityUndertakingPrint = forwardRef(
  ({ taskData }: Props, ref) => {
    const headings = [
      "#",
      "Matter Number",
        ...
        <div>
          ...
          >
            ...
            >
              ...
              >
                <span className="cls_002">
                  Please use this space to add any additional comments related
            ...
            >
              ...
              >
                <span className="cls_002">
                  particulars relating to my acting in a representative
                  capacity;
                </span>
              </div>
              <div
              ...
              >
                <span className="cls_002">
                  to the extent of my lawful ability, the books, records,
                  accounts and documents of the estate or trust, in a form
...
export default RepresCapacityUndertakingPrint;
