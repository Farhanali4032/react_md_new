...
const BankDraftsAndMoneyOrderPrint = forwardRef(({ taskData }: Props, ref) => {
  const method = [
    ...
    <Container ref={ref}>
      ...
      >
        ...
        >
          ...
          >
            <span className="cls_002">
              ...
              If a trust withdrawal is to be made by this method, fill out this
              form and maintain a copy in the clients file.
            </span>
          </div>
          {/* <div
              style={{
          ...
          >
            <span className="cls_011">
              ...
              Conduct, or a resolution of the Benchers and will be accessible to
              all departments of the Law Society, including the Alberta Lawyers
              Insurance Association. The information may be used or disclosed by
              the Law Society of Alberta, now or in the future, for regulatory
              purposes, including Law Society of Alberta investigations and
              proceedings. We may contact you to obtain additional information,
              or to obtain clarification on the information you provided. Should
              you have any questions about this, please contact the Privacy
              Officer at 403-229-4700.
            </span>
        ...
        >
          ...
          <div style={{ position: "absolute", left: "80.66px", top: "340px" }}>
            <input
          ...
          <div style={{ position: "absolute", left: "272.09px", top: "340px" }}>
            <input
...
export default BankDraftsAndMoneyOrderPrint;
