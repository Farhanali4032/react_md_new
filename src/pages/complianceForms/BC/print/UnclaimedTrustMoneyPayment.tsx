...
const UnclaimedTrustMoneyPayment = forwardRef(({ taskData }: Props, ref) => {
      ...
      >
        ...
        >
          ...
          >
            <span className="cls_010">
              ...
              whom the lawyer has been unable to locate for 2 years may apply to
              the Executive Director to pay those funds to the Society under
          ...
          >
            <span className="cls_010">
              (2) A lawyer must make the application referred to in subrule (1)
              in writing containing all of the following information that is
          ...
          >
            <span className="cls_010">
              (a) the full name and last known mailing address of each person on
              whose behalf the lawyer held the money;
            </span>
          </div>
          {/* <div
              style={{
          ...
          >
            <span className="cls_010">
              (b) the exact amount to be paid to the Society in respect of each
              such person;
            </span>
          </div>
          <div
        ...
        >
          ...
          <div
            ...
            className="cls_010"
          >
            <span className="cls_010">Name of rightful owner(s) of funds</span>
            <input
              onChange={handleInputChange}
              type="text"
              className="htmlInput htmlInput_m"
...
export default UnclaimedTrustMoneyPayment;
