...
const ConfirmInterestRemittance = forwardRef(({ taskData }: Props, ref) => {
        ...
        >
          ...
          >
            <span className="cls_006">
              ...
              pursuant to the regulations of the Law Society of British Columbia
              and the <i>Legal Profession Act</i> , a lawyer who opens or
              maintains a pooled trust account must direct the savings
              institution to remit the interest earned on the pooled trust
              account, net of service charges if any, to the Law Foundation of
          ...
          <div
            style={{ position: "absolute", left: "72.00px", top: "340.50px" }}
            className="cls_006"
          >
            <span className="cls_006">
              ...
              Foundation as, in some instances, this process may be performed at
              a central administration branch.
            </span>
          </div>
          {/* <div
          ...
          <div
            style={{ position: "absolute", left: "72.00px", top: "405.72px" }}
            className="cls_006"
          >
            <span className="cls_006">
          ...
          >
            <span className="cls_011">
              ...
              interest earned has been, and is being, paid to the Law Foundation
              of British Columbia.
            </span>
          </div>
          {/* <div
          ...
          <div
            ...
            className="cls_013"
          >
            <span className="cls_013">The Law Society of British Columbia</span>
          </div>
          <div
            style={{
              position: "absolute",
...
export default ConfirmInterestRemittance;
