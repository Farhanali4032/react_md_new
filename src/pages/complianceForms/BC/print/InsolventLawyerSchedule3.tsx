...
const InsolventLawyerSchedule3 = forwardRef(({ taskData }: Props, ref) => {
  ...
  return (
    <Container ref={ref}>
      <div className="page_containers" id="page_container">
        <div
          style={{
            display: "inline",
            height: "auto",
        ...
        >
          ...
          >
            <span className="cls_006">
              I did not operate a trust account except with a second signatory
              who is a practising lawyer (not an insolvent lawyer) as approved
              by the Executive Director of the Law Society of British Columbia,
              namely
            </span>
          </div>
          <div
          ...
          >
            <span className="cls_006">
              All withdrawals from trust were made by way of cheque as required
              by Rule 3-64 (5) (a) of the Law Society Rules as adopted by the
              Benchers of the Law Society of British Columbia under the
              authority of the Legal Profession Act, S.B.C. 1998 c. 9 as amended
            </span>
          ...
          >
            <span className="cls_006">
              ...
              accountant my obligations under Rule 3-51 (3) and my compliance
              thereby.
            </span>
            <span className="cls_011"></span>
          </div>
          ...
          >
            <span className="cls_006">
              ...
              be true and knowing that it is of the same legal force and effect
          ...
          >
            <span className="cls_012">
              The information in this form is collected under section 33 of the
              Legal Profession Act and Rule 3-51 (3) of the Law Society Rules.
              The information will be used to process your Trust Report. If you
              have any questions about the collection of this information,
              please contact Trust Assurance. The Law Society of British
              Columbia, 845 Cambie Street, Vancouver, B.C. V6B 4Z9, 604.697.5810
              or toll free in B.C. 1.800.903.5300 ext 5810 or
              trustaccounting@lsbc.org.
            </span>
          </div>
          {/* <div
                style={{
...
export default InsolventLawyerSchedule3;
