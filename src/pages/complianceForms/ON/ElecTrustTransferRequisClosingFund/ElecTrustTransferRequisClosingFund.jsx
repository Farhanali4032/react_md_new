...
import Form9C from "../print/Form9C";
import Dropdown from "react-dropdown";
import { useReactToPrint } from "react-to-print";

const ElecTrustTransferRequisClosingFund: React.FC<{}> = () => {
  ...
  return (
    ...
    >
      <div style={{ display: "none" }}>
        <Form9C taskData={taskState} ref={compliancePDF} />
      </div>
      <Container>
        <div
...
export default ElecTrustTransferRequisClosingFund;
