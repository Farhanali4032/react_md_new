...
import { ReportOnTheInvestment } from "../ReportOnTheInvestment/ReportOnTheInvestment";
    ...
    <Container ref={ref}>
      ...
      >
        ...
        <div className="mx-5 mt-5">
          ...
          <div className="mx-5 fw-bold my-4">B. Conditions and disclosure:</div>

          <div>
            <div className="mx-5">
              In accordance with your Form 9D [Investment Authority] request for
              information and disclosures prior to the advance of your money, I
              advise that I have previously provided you with the requested
              information and disclosures as follows:
            </div>
            <LabelAndInput
              classes="mt-3 my-1"
            ...
            <div className="my-3 mx-5">
              4. Any loss you may suffer on this mortgage investment will not be
              insured under the lawyers' professional liability policy if the
              lawyer has acted as a mortgage broker or has helped to arrange it.
              I advised and you acknowledged having read and understood this
              warning.
            </div>
          </div>
