...
import { InvestmentAuthorState } from "./InvestmentAuthor";
import { Task } from "../../../../components/Tasks/Task";
import Form9D from "../print/Form9D";
  ...
  return (
    ...
    >
      <div style={{ display: "none" }}>
        <Form9D taskData={taskState} ref={compliancePDF} />
      </div>
      <Container>
        <div
        ...
        >
          ...
          <div className="mx-5">
            ...
            <div className=" mx-5">
              I (or we) instruct you to act on my (or our) behalf, on my (or
              our) mortgage investment (or investments) of{" "}
              <input
                type="number"
                ...
                name="specifyAmount"
              />{" "}
              the details, conditions and disclosures of which are set out
              below.
            </div>
            ...
            <div className="mx-5">
              ...
              <div className="my-3">
                ...
                lawyer before you complete the transaction and make the advance
                is as follows:
              </div>
              ...
              <div className="my-3">
                ...
                prospectus is necessary, a copy of the prospectus. We
                acknowledge and accept that you as my (or our) lawyer express no
                opinion as to the necessity for or validity of a prospectus.
              </div>

              <div className="my-3">
                2. (Instructions: Each investor to complete and initial clause
                (a) and, if clause (a) is answered in the affirmative, to
                complete (if necessary) and initial clause (b) and to initial
                clause (c).
              </div>
            </div>
            ...
            <div className="mx-5">
              ...
              <div>
                ...
                investor or investors at all times. The lawyer's responsibility
                is limited to ensuring the mortgage is legally registered on
                title in accordance with the investor's or investors’
                instructions. The lawyer is not permitted to personally
                guarantee the obligations of the borrower or borrowers nor the
                suitability of the property as security for the mortgage
                investment.
                <br />
                2. Any loss you may suffer on this mortgage investment will not
                be insured under the lawyer’s professional liability policy if
                the lawyer has acted as a mortgage broker or has helped to
                arrange it.*)
              </div>

              <div className="my-3">
                I (or we) hereby acknowledge receipt of a copy of this form
                prior to the advance of funds to or on behalf of the borrower
