...
const Form9A = forwardRef(({ taskData }: Props, ref) => {
  const taskState: Task = taskData;
  const [taskStatus, setTaskStatus] = useState(taskData);
  ...
  return (
    <div id="compliance_form_print" ref={ref}>
      ...
      >
        ...
        <div
          ...
          className="cls_002"
        >
          <span className="cls_002">Electronic Trust Transfer Requisition</span>
        </div>
        <div
        ...
        >
          ...
          <input
            ...
            name="amountOfFunds"
            type="text"
            value={formatNumber(parseInt(sectionA.amountOfFunds))}
            onChange={(e) => handleInputChange(e)}
          />
        </div>
        ...
        >
          ...
          <input
            className="cls_004 htmlInput_wide htmlInput"
            name="Re"
            value={sectionA.Re}
            onChange={(e) => handleInputChange(e)}
          />
        ...
        <div
          ...
          className="cls_003  d-flex justify-content-between"
        >
          <span className="cls_003">Person entering details of transfer:</span>
          <input
            className="cls_004 htmlInput htmlInput_m "
